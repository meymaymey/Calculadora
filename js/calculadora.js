//TENER LOCALIZADO EL DIV PARA PODER ESCRIBIR EN ELLA

window.onload = function(){ //Acciones tras cargar la página
    pantalla=document.getElementById("textoPantalla"); //elemento pantalla de salida
}

//variables para controlar pantalla
...
//PARA INTRODUCIR LOS NUMEROS Y LA COMA Y QUE SEAN VISIBLES

    //funcion para visualizar numero
function numero(xx) {  //recoge el número pulsado en el argumento.
    ...
    //funcion para visualizar la coma
